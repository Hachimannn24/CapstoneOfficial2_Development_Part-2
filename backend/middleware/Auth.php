...
class Auth
{
    ...
    public static function authenticateUser(): bool
    {
        ...
        try {
            ...
            $stmt = $db->prepare('SELECT id, name, email, role, branch, is_active, backup_email, mfa_enabled, mfa_secret, backup_codes, google_id, google_email, is_online, last_active FROM users WHERE id = ?');
