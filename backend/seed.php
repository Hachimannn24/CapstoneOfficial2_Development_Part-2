...
// =============================================
$defaultUsers = [
    ['name' => 'System Owner',           'role' => 'owner',     'email' => 'owner@hontech.com', 'password' => Env::get('OWNER_PASSWORD', 'owner123')],
    ['name' => 'System Admin',           'role' => 'admin',     'email' => 'admin@hontech.com', 'password' => Env::get('ADMIN_PASSWORD', 'admin123')],
    ['name' => 'Jessica (Front Desk)',   'role' => 'assistant', 'email' => 'staff@hontech.com', 'password' => Env::get('STAFF_PASSWORD', 'staff123')],
    ['name' => 'Mark (Advisor)',         'role' => 'sa',        'email' => 'sa@hontech.com',    'password' => Env::get('SA_PASSWORD', 'sa123')],
    ['name' => 'Dave (Advisor)',         'role' => 'sa',        'email' => 'tech@hontech.com',  'password' => Env::get('TECH_PASSWORD', 'tech123')],
];
